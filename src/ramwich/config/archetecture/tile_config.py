...
class TileConfig(BaseModel):
    ...
    edram_bus_lat: float = Field(default=9.89, description="EDRAM bus latency")
    edram_bus_pow_dyn: float = Field(default=0.798593, description="EDRAM bus dynamic power")
    edram_bus_pow_leak: float = Field(default=0.092511, description="EDRAM bus leakage power")
    edram_bus_area: float = Field(default=0.000402693121, description="EDRAM bus area")

    # EDRAM controller values
    edram_ctrl_lat: float = Field(default=7.90, description="EDRAM controller latency")
    ...
    receive_buffer_lat: float = Field(default=9.89, description="Receive buffer latency")
