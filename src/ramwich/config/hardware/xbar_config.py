...
class XBARConfig(BaseModel):
    ...
    INMEM_LAT_DICT: ClassVar[dict[int, float]] = {32: 1, 64: 1, 128: 2, 256: 2}
    ...
    # XBAR lookup tables
    XBAR_LAT_DICT: ClassVar[dict[int, float]] = {32: 1, 64: 1, 128: 1, 256: 1}
    ...
    SRAM_XBAR_LAT_DICT: ClassVar[dict[int, float]] = {32: 1, 64: 1, 128: 1, 256: 1}
    ...
    OUTMEM_LAT_DICT: ClassVar[dict[int, float]] = {32: 1, 64: 1, 128: 2, 256: 2}
