...
def process_batch(
    ...
    simulator = RAMwich(
        json_config_file=config_dict["json_config_file"],
        yaml_config_file=config_dict["yaml_config_file"],
        ops_file=config_dict["ops_file"],
        params_file=config_dict["params_file"],
    )
...
def main():
    yaml_config_file = "examples/ResNet_20_cifar100/config.yaml"
    json_config_file = "examples/ResNet_20_cifar100/config.json"
    ops_file = "examples/ResNet_20_cifar100/ops.json"
    params_file = "examples/ResNet_20_cifar100/params.npz"
